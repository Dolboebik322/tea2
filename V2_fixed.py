...
class FootballTrader:
    ...
    def get_gas_prices(self) -> Dict:
        ...
        nonce_result = self.rpc_call("eth_call", [{
            ...
            "to": self.config.trade_contract_address
        }, "latest"])
    ...
    def get_paymaster_data(self, user_op: Dict) -> str:
        ...
        payload = {
            ...
            "params": [user_op, self.config.entry_point_address, "0x8453", {}]
        }
    ...
    def buy_player_complete(self, player_id: int, shares: int = 1) -> Dict:
        ...
        try:
            ...
            # 7. Получаем данные paymaster
            print("\n7️⃣ Получаем данные paymaster...")
            paymaster_data = self.get_paymaster_data(base_user_op)
            base_user_op["paymasterAndData"] = paymaster_data
