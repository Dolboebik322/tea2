...
class FootballTrader:
    ...
    def buy_player_simple(self, player_id: int, shares: int = 1) -> Dict:
        ...
        try:
            ...
            # 5. Создаем UserOperation с фиксированными значениями
            print("\n5️⃣ Создаем UserOperation...")
            
            # Используем фиксированные данные paymaster из реальных запросов
            ...
            paymaster_data = f"0x{paymaster_address}000{deadline_hex}" + "0" * 128
            ...
            user_op = {
                ...
                "initCode": "0x",
                "callData": call_data,
                "callGasLimit": "0x39bb8",  # Фиксированное значение из curl
                "verificationGasLimit": "0x1b7740",
                "preVerificationGas": "0x6b9f",
